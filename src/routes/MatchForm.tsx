...
export function MatchForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const matches = await getMatches(formData);
      
      // Save profile and matches
    ...
    <div className="container mx-auto max-w-2xl px-4 py-8">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Tell us about yourself and we'll find the perfect matches for your hackathon team
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <TokenInput
                ...
                suggestions={SKILLS as readonly string[] as string[]}
            ...
            >
              <Textarea
                ...
                aria-describedby="blurb-description"
              />
            </FormField>
